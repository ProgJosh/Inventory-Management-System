...
export const createSeedData = (): InventoryDatabase => ({
  users: [
    { id: 'usr-admin', name: 'Josh Velo', email: 'admin@ims.io', password: 'admin123', role: 'Admin', initials: 'JV', status: 'active', createdAt: daysAgo(240) },
    { id: 'usr-manager', name: 'Josh Velo', email: 'manager@ims.io', password: 'manager123', role: 'Manager', initials: 'JV', status: 'active', createdAt: daysAgo(185) },
